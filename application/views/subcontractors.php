        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components text-center">
                ...
                <li>
                    ...
                    <a href="<?php echo base_url();?>Employees/subcontractors"  aria-expanded="false"> Subcontractors</a>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <!-- <button type="button" id="sidebarCollapse" class="btn btn-info">
						...
						<div class="container">
			  <h2>Registered subcontractors</h2>
			  ...
			  <table class="table table-striped">
			    ...
			    <tbody>
			      ...
			      foreach($subcontractors as $subcontractor)
			      {
			      	echo "<tr>";
			      		echo "<td>";
			      			echo $subcontractor['firstname'];
			      		echo "</td>";
			      		echo "<td>";
			      			echo $subcontractor['lastname'];
			      		echo "</td>";
			      		echo "<td>";
			      			echo $subcontractor['phonenumber'];
			      		echo "</td>";
			      		echo "<td>";
			      			echo $subcontractor['address'];
			      		echo "</td>";
			      		echo "<td>";
			      			echo $subcontractor['email'];
			      		echo "</td>";
			      	echo "</tr>";
			      }
			      ?>
