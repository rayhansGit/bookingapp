   ...
   var calendar = $('#calendar').fullCalendar({
    ...
    select: function(start, end, allDay)
    {
      ...
      $("#submit").click(function() {
        ...
        {
          if(document.getElementById("startclock").value==document.getElementById("endclock").value)
          {
            alert("Your start and end time is same!");
          }
          else
          {
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <label for="p-in" class="col-md-4 label-heading">Velg farge</label>
                      
                      <button class="btn favcolor" value="green" style="background-color: green" onclick="setpostcolor(this)">Grønn</button>
                      <button class="btn favcolor" value="blue" style="background-color: blue" onclick="setpostcolor(this)">Blå</button>
                      <button class="btn favcolor" value="red" style="background-color: red" onclick="setpostcolor(this)">Rød</button>
                      <button class="btn favcolor" value="yellow" style="background-color: yellow;color: black !important" onclick="setpostcolor(this)">Gul</button>
                      <button class="btn favcolor" value="purple" style="background-color: purple" onclick="setpostcolor(this)">Lilla</button>
